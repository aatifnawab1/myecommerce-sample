...
export const perfumes = [
  {
    id: 'perf-1',
    name_en: 'Essence Noir',
    name_ar: 'جوهر نوار',
    category: 'perfume',
    price: 450,
    originalPrice: 550,
    currency: 'SAR',
    description_en: 'A sophisticated blend of oud and amber, crafted for the modern connoisseur. Long-lasting fragrance with notes of sandalwood and vanilla.',
    description_ar: 'مزيج متطور من العود والعنبر، مصمم خصيصاً لعشاق العطور المميزين. عطر طويل الأمد بنفحات خشب الصندل والفانيليا.',
  ...
  {
    id: 'perf-2',
    name_en: 'Royal Velvet',
    name_ar: 'المخمل الملكي',
    category: 'perfume',
    price: 520,
    originalPrice: 620,
    currency: 'SAR',
    description_en: 'Luxurious oriental fragrance with rich black pepper, musk, and leather accords. A statement of elegance and power.',
    description_ar: 'عطر شرقي فاخر بنفحات الفلفل الأسود الغني والمسك والجلد. تعبير عن الأناقة والقوة.',
  ...
  {
    id: 'perf-3',
    name_en: 'Luxe Éternelle',
    name_ar: 'لوكس الأبدية',
    category: 'perfume',
    price: 680,
    originalPrice: 780,
    currency: 'SAR',
    description_en: 'The epitome of timeless elegance. A classic floral bouquet with jasmine, rose, and ylang-ylang, finished with powdery aldehydes.',
    description_ar: 'قمة الأناقة الخالدة. باقة زهرية كلاسيكية من الياسمين والورد والإيلنغ، مع لمسة ناعمة من الألدهيدات.',
  ...
  {
    id: 'perf-4',
    name_en: 'Aqua Mystique',
    name_ar: 'أكوا الغموض',
    category: 'perfume',
    price: 380,
    originalPrice: 480,
    currency: 'SAR',
    description_en: 'Fresh and invigorating aquatic fragrance with citrus top notes, marine accord, and woody base. Perfect for everyday luxury.',
    description_ar: 'عطر مائي منعش ومنشط بنفحات حمضيات علوية ونغمات بحرية وقاعدة خشبية. مثالي للفخامة اليومية.',
  ...
  },
  {
    ...
    originalPrice: 690,
    currency: 'SAR',
    description_en: 'An exotic blend inspired by Arabian nights. Rich saffron, warm amber, and delicate rose petals create an unforgettable aura.',
    description_ar: 'مزيج ساحر مستوحى من الليالي العربية. زعفران غني وعنبر دافئ وبتلات ورد رقيقة تخلق هالة لا تُنسى.',
  ...
  },
  {
    ...
    name_ar: 'عود منتصف الليل',
    category: 'perfume',
    price: 750,
    originalPrice: 850,
    currency: 'SAR',
    description_en: 'Intense and captivating oud fragrance with dark chocolate, coffee, and patchouli. For those who dare to be different.',
    description_ar: 'عطر عود قوي وآسر مع الشوكولاتة الداكنة والقهوة والباتشولي. لمن يجرؤ على التميز.',
  ...
  },
  {
    ...
    name_ar: 'الرمال الذهبية',
    category: 'perfume',
    price: 420,
    originalPrice: 520,
    currency: 'SAR',
    description_en: 'Warm and sensual fragrance with honey, vanilla, and amber. A golden embrace of desert luxury and sophistication.',
    description_ar: 'عطر دافئ وحسي بالعسل والفانيليا والعنبر. احتضان ذهبي من فخامة الصحراء والرقي.',
    image: 'https://images.unsplash.com/photo-1523293182086-7651a899d37f?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1ODB8MHwxfHNlYXJjaHwxfHxwZXJmdW1lJTIwYm90dGxlfGVufDB8fHx8MTc2NjU5Nzc1MHww&ixlib=rb-4.1.0&q=85',
    inStock: true,
    rating: 4.5,
    reviews: 76
  ...
  {
    id: 'perf-8',
    name_en: 'Opulence Premier',
    name_ar: 'أوبيولنس بريمير',
    category: 'perfume',
    price: 890,
    originalPrice: 990,
    currency: 'SAR',
    description_en: 'The pinnacle of luxury perfumery. Rare ingredients including iris, vetiver, and aged oud create an extraordinary signature scent.',
    description_ar: 'قمة صناعة العطور الفاخرة. مكونات نادرة تشمل السوسن والفيتيفر والعود المعتق تخلق عطراً استثنائياً لا يُضاهى.',
    image: 'https://images.unsplash.com/photo-1585218334450-afcf929da36e?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1ODB8MHwxfHNlYXJjaHwyfHxwZXJmdW1lJTIwYm90dGxlfGVufDB8fHx8MTc2NjU5Nzc1MHww&ixlib=rb-4.1.0&q=85',
    inStock: false,
    rating: 5.0,
    reviews: 201
