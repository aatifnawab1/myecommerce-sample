      ...
      <div className="container mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">
            Luxury <span className="text-amber-500">{t('perfumes')}</span>
          </h1>
          <p className="text-gray-400">Experience the finest fragrances from around the world</p>
        </div>
        ...
        {filteredAndSortedProducts.length === 0 && (
          <div className="text-center py-20">
            <p className="text-gray-400 text-lg">No perfumes found matching your criteria.</p>
          </div>
        )}
      </div>
    </div>
